...
parser.add_argument("--img_size", type=int, default=28, help="size of each image channels")
parser.add_argument("--channels", type=int, default=1, help="number of image channels")
parser.add_argument("--sample_interval", type=int, default=400, help="interval between image channels")
